...
public class GroupID {
    ...
    @JsonProperty("allOf")
    private List<AllOf__60> allOf = new ArrayList<AllOf__60>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__48 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__60> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__60> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__48 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__48 elementName) {
    ...
    public String toString() {
        ...
        sb.append(GroupID.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GroupID) == false) {
            return false;
        }
        GroupID rhs = ((GroupID) other);
