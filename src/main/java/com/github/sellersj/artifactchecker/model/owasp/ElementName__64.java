...
public class ElementName__64 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__64.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__64) == false) {
            return false;
        }
        ElementName__64 rhs = ((ElementName__64) other);
