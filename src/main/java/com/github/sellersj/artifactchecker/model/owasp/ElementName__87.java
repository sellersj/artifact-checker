...
public class ElementName__87 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__87.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__87) == false) {
            return false;
        }
        ElementName__87 rhs = ((ElementName__87) other);
