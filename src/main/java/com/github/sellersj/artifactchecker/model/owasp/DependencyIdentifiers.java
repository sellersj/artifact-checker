...
public class DependencyIdentifiers {
    ...
    public String toString() {
        ...
        sb.append(DependencyIdentifiers.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DependencyIdentifiers) == false) {
            return false;
        }
        DependencyIdentifiers rhs = ((DependencyIdentifiers) other);
