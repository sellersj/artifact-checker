...
public class AllOf__100 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__20 items;
    ...
    @JsonProperty("items")
    public Items__20 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__20 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__100.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__100) == false) {
            return false;
        }
        AllOf__100 rhs = ((AllOf__100) other);
