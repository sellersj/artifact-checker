...
public class Score {
    ...
    @JsonProperty("allOf")
    private List<AllOf__91> allOf = new ArrayList<AllOf__91>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__78 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__91> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__91> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__78 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__78 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Score.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
