...
public class Sha256__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__71> allOf = new ArrayList<AllOf__71>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__59 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__71> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__71> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__59 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__59 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Sha256__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sha256__1) == false) {
            return false;
        }
        Sha256__1 rhs = ((Sha256__1) other);
