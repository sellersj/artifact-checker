...
public class ElementName__76 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__76.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__76) == false) {
            return false;
        }
        ElementName__76 rhs = ((ElementName__76) other);
