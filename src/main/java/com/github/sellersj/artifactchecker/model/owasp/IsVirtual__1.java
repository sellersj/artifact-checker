...
public class IsVirtual__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__80> allOf = new ArrayList<AllOf__80>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__11 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__80> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__80> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__11 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__11 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(IsVirtual__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IsVirtual__1) == false) {
            return false;
        }
        IsVirtual__1 rhs = ((IsVirtual__1) other);
