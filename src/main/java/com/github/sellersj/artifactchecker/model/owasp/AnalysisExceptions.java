...
public class AnalysisExceptions {
    ...
    @JsonProperty("allOf")
    private List<AllOf__76> allOf = new ArrayList<AllOf__76>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__64 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__76> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__76> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__64 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__64 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AnalysisExceptions.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnalysisExceptions) == false) {
            return false;
        }
        AnalysisExceptions rhs = ((AnalysisExceptions) other);
