...
public class ElementName__89 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__89.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__89) == false) {
            return false;
        }
        ElementName__89 rhs = ((ElementName__89) other);
