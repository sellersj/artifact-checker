...
public class ElementName__42 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__42.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__42) == false) {
            return false;
        }
        ElementName__42 rhs = ((ElementName__42) other);
