...
public class ElementName__86 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__86.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__86) == false) {
            return false;
        }
        ElementName__86 rhs = ((ElementName__86) other);
