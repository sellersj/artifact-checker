...
public class AvailabilityImpact__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__97> allOf = new ArrayList<AllOf__97>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__84 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__97> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__97> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__84 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__84 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AvailabilityImpact__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AvailabilityImpact__1) == false) {
            return false;
        }
        AvailabilityImpact__1 rhs = ((AvailabilityImpact__1) other);
