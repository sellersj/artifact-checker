...
public class Vulnerable {
    ...
    @JsonProperty("allOf")
    private List<AllOf__58> allOf = new ArrayList<AllOf__58>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__10 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__58> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__58> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__10 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__10 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(Vulnerable.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vulnerable) == false) {
            return false;
        }
        Vulnerable rhs = ((Vulnerable) other);
