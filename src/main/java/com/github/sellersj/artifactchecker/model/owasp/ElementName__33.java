...
public class ElementName__33 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__33.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__33) == false) {
            return false;
        }
        ElementName__33 rhs = ((ElementName__33) other);
