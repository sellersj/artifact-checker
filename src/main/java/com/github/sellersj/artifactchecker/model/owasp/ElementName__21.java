...
public class ElementName__21 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__21.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__21) == false) {
            return false;
        }
        ElementName__21 rhs = ((ElementName__21) other);
