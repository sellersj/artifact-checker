...
public class AttributeName__10 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__10.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__10) == false) {
            return false;
        }
        AttributeName__10 rhs = ((AttributeName__10) other);
