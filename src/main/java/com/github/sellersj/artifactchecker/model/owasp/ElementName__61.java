...
public class ElementName__61 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__61.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__61) == false) {
            return false;
        }
        ElementName__61 rhs = ((ElementName__61) other);
