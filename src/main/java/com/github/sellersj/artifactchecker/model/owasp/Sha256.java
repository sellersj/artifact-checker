...
public class Sha256 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__47> allOf = new ArrayList<AllOf__47>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__43 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__47> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__47> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__43 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__43 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Sha256.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sha256) == false) {
            return false;
        }
        Sha256 rhs = ((Sha256) other);
