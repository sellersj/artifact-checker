...
public class AttributeName__5 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__5.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__5) == false) {
            return false;
        }
        AttributeName__5 rhs = ((AttributeName__5) other);
