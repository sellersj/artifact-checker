...
public class AllOf__32 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__32.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__32) == false) {
            return false;
        }
        AllOf__32 rhs = ((AllOf__32) other);
