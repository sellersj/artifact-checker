...
public class VersionStartExcluding {
    ...
    @JsonProperty("allOf")
    private List<AllOf__55> allOf = new ArrayList<AllOf__55>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__7 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__55> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__55> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__7 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__7 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(VersionStartExcluding.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VersionStartExcluding) == false) {
            return false;
        }
        VersionStartExcluding rhs = ((VersionStartExcluding) other);
