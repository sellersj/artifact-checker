...
public class AttributeName__11 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__11.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__11) == false) {
            return false;
        }
        AttributeName__11 rhs = ((AttributeName__11) other);
