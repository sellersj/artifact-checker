...
public class ElementName__37 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__37.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__37) == false) {
            return false;
        }
        ElementName__37 rhs = ((ElementName__37) other);
