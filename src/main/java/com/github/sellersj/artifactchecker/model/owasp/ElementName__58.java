...
public class ElementName__58 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__58.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__58) == false) {
            return false;
        }
        ElementName__58 rhs = ((ElementName__58) other);
