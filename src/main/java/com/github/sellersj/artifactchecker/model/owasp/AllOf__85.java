...
public class AllOf__85 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__13 items;
    ...
    @JsonProperty("items")
    public Items__13 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__13 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__85.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__85) == false) {
            return false;
        }
        AllOf__85 rhs = ((AllOf__85) other);
