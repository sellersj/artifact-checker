...
public class IntegrityImpact {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__21> allOf = new ArrayList<AllOf__21>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__20 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__21> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__21> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__20 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__20 elementName) {
    ...
    public String toString() {
        ...
        sb.append(IntegrityImpact.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IntegrityImpact) == false) {
            return false;
        }
        IntegrityImpact rhs = ((IntegrityImpact) other);
