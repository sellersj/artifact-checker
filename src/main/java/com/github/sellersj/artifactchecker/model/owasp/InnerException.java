...
public class InnerException {
    ...
    @JsonProperty("allOf")
    private List<AllOf__42> allOf = new ArrayList<AllOf__42>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__38 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__42> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__42> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__38 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__38 elementName) {
    ...
    public String toString() {
        ...
        sb.append(InnerException.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InnerException) == false) {
            return false;
        }
        InnerException rhs = ((InnerException) other);
