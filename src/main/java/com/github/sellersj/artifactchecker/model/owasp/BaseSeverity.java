...
public class BaseSeverity {
    ...
    @JsonProperty("allOf")
    private List<AllOf__23> allOf = new ArrayList<AllOf__23>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__22 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__23> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__23> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__22 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__22 elementName) {
    ...
    public String toString() {
        ...
        sb.append(BaseSeverity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BaseSeverity) == false) {
            return false;
        }
        BaseSeverity rhs = ((BaseSeverity) other);
