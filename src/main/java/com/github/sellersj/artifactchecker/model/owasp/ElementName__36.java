...
public class ElementName__36 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__36.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__36) == false) {
            return false;
        }
        ElementName__36 rhs = ((ElementName__36) other);
