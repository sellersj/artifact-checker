...
public class Scope {
    ...
    @JsonProperty("allOf")
    private List<AllOf__19> allOf = new ArrayList<AllOf__19>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__18 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__19> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__19> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__18 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__18 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Scope.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
