...
public class Properties__18 {
    ...
    private StackTrace__1 stackTrace;
    ...
    @JsonProperty("stackTrace")
    public StackTrace__1 getStackTrace() {
        return stackTrace;
    }

    @JsonProperty("stackTrace")
    public void setStackTrace(StackTrace__1 stackTrace) {
    ...
    public String toString() {
        ...
        sb.append(Properties__18.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Properties__18) == false) {
            return false;
        }
        Properties__18 rhs = ((Properties__18) other);
