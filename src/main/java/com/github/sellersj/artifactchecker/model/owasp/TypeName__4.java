...
public class TypeName__4 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__4.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__4) == false) {
            return false;
        }
        TypeName__4 rhs = ((TypeName__4) other);
