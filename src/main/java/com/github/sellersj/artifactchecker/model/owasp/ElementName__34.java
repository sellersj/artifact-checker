...
public class ElementName__34 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__34.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__34) == false) {
            return false;
        }
        ElementName__34 rhs = ((ElementName__34) other);
