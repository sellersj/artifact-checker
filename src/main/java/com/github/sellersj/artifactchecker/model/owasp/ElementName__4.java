...
public class ElementName__4 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__4.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__4) == false) {
            return false;
        }
        ElementName__4 rhs = ((ElementName__4) other);
