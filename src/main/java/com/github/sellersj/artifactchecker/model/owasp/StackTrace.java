...
public class StackTrace {
    ...
    @JsonProperty("allOf")
    private List<AllOf__41> allOf = new ArrayList<AllOf__41>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__37 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__41> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__41> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__37 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__37 elementName) {
    ...
    public String toString() {
        ...
        sb.append(StackTrace.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
