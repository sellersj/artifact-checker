...
public class ElementName__71 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__71.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__71) == false) {
            return false;
        }
        ElementName__71 rhs = ((ElementName__71) other);
