...
public class AttributeName__8 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__8.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__8) == false) {
            return false;
        }
        AttributeName__8 rhs = ((AttributeName__8) other);
