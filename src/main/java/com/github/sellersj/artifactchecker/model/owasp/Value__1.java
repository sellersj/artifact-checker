...
@JsonPropertyOrder({"title", "allOf", "propertyType"})
public class Value__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__52> allOf = new ArrayList<AllOf__52>();
    ...
    @JsonProperty("allOf")
    public List<AllOf__52> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__52> allOf) {
        this.allOf = allOf;
    }
    ...
    public String toString() {
        ...
        sb.append(Value__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
