...
public class ElementName__28 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__28.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__28) == false) {
            return false;
        }
        ElementName__28 rhs = ((ElementName__28) other);
