...
public class Evidence__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__99> allOf = new ArrayList<AllOf__99>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__86 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__99> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__99> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__86 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__86 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Evidence__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Evidence__1) == false) {
            return false;
        }
        Evidence__1 rhs = ((Evidence__1) other);
