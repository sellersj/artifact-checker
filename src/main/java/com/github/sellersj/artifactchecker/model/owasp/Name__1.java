...
public class Name__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__12> allOf = new ArrayList<AllOf__12>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__11 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__12> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__12> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__11 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__11 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Name__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
