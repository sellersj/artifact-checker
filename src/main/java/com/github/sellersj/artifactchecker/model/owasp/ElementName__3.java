...
public class ElementName__3 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__3) == false) {
            return false;
        }
        ElementName__3 rhs = ((ElementName__3) other);
