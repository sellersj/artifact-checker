...
public class DependencyProjectReferences {
    ...
    public String toString() {
        ...
        sb.append(DependencyProjectReferences.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DependencyProjectReferences) == false) {
            return false;
        }
        DependencyProjectReferences rhs = ((DependencyProjectReferences) other);
