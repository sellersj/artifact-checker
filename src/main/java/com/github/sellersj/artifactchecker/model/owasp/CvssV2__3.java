...
public class CvssV2__3 {
    ...
    @JsonProperty("typeName")
    public TypeName__11 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__11 typeName) {
    ...
    public String toString() {
        ...
        sb.append(CvssV2__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CvssV2__3) == false) {
            return false;
        }
        CvssV2__3 rhs = ((CvssV2__3) other);
