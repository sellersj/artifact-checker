...
public class Source__2 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__27> allOf = new ArrayList<AllOf__27>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__26 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__27> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__27> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__26 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__26 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Source__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Source__2) == false) {
            return false;
        }
        Source__2 rhs = ((Source__2) other);
