...
public class Dependency__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__26> allOf = new ArrayList<AllOf__26>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__25 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__26> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__26> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__25 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__25 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Dependency__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dependency__1) == false) {
            return false;
        }
        Dependency__1 rhs = ((Dependency__1) other);
