...
public class DataSource__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__82> allOf = new ArrayList<AllOf__82>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__69 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__82> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__82> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__69 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__69 elementName) {
    ...
    public String toString() {
        ...
        sb.append(DataSource__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataSource__1) == false) {
            return false;
        }
        DataSource__1 rhs = ((DataSource__1) other);
