...
public class Description__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__37> allOf = new ArrayList<AllOf__37>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__34 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__37> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__37> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__34 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__34 elementName) {
