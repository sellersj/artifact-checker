...
public class Name__4 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__59> allOf = new ArrayList<AllOf__59>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__47 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__59> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__59> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__47 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__47 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Name__4.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Name__4) == false) {
            return false;
        }
        Name__4 rhs = ((Name__4) other);
