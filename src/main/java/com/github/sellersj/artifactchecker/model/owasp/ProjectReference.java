...
public class ProjectReference {
    ...
    @JsonProperty("allOf")
    private List<AllOf__90> allOf = new ArrayList<AllOf__90>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__77 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__90> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__90> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__77 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__77 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ProjectReference.class.getName()).append('@')
