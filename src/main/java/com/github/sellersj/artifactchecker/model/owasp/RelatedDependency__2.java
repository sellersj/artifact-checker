...
public class RelatedDependency__2 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__100> allOf = new ArrayList<AllOf__100>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__87 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__100> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__100> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__87 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__87 elementName) {
    ...
    public String toString() {
        ...
        sb.append(RelatedDependency__2.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedDependency__2) == false) {
            return false;
        }
        RelatedDependency__2 rhs = ((RelatedDependency__2) other);
