...
public class ReportDate {
    ...
    @JsonProperty("allOf")
    private List<AllOf__63> allOf = new ArrayList<AllOf__63>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__51 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__63> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__63> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__51 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__51 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ReportDate.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
