...
public class ProjectReferences {
    ...
    @JsonProperty("allOf")
    private List<AllOf__74> allOf = new ArrayList<AllOf__74>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__62 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__74> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__74> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__62 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__62 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ProjectReferences.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProjectReferences) == false) {
            return false;
        }
        ProjectReferences rhs = ((ProjectReferences) other);
