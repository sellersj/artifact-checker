...
public class AttributeName__3 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__3.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__3) == false) {
            return false;
        }
        AttributeName__3 rhs = ((AttributeName__3) other);
