...
public class AllOf__84 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__12 items;
    ...
    @JsonProperty("items")
    public Items__12 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__12 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__84.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__84) == false) {
            return false;
        }
        AllOf__84 rhs = ((AllOf__84) other);
