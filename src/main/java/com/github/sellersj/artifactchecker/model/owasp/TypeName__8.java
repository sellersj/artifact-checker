...
public class TypeName__8 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__8.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__8) == false) {
            return false;
        }
        TypeName__8 rhs = ((TypeName__8) other);
