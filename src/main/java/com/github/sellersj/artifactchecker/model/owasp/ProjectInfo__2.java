...
@JsonPropertyOrder({"type", "title", "required", "properties", "typeType", "typeName", "propertiesOrder"})
public class ProjectInfo__2 {
    ...
    @JsonProperty("typeName")
    public TypeName__8 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__8 typeName) {
    ...
    public String toString() {
        ...
        sb.append(ProjectInfo__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProjectInfo__2) == false) {
            return false;
        }
        ProjectInfo__2 rhs = ((ProjectInfo__2) other);
        return (((((((((this.propertiesOrder == rhs.propertiesOrder)
            ...
            && ((this.required == rhs.required) || ((this.required != null) && this.required.equals(rhs.required))))
