...
public class ElementName__13 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__13.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__13) == false) {
            return false;
        }
        ElementName__13 rhs = ((ElementName__13) other);
