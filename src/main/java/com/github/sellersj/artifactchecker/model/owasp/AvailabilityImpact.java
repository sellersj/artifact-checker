...
public class AvailabilityImpact {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__22> allOf = new ArrayList<AllOf__22>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__21 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__22> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__22> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__21 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__21 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AvailabilityImpact.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AvailabilityImpact) == false) {
            return false;
        }
        AvailabilityImpact rhs = ((AvailabilityImpact) other);
