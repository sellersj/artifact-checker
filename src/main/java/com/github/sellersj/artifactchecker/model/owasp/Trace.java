...
public class Trace {
    ...
    @JsonProperty("allOf")
    private List<AllOf__65> allOf = new ArrayList<AllOf__65>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__53 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__65> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__65> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__53 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__53 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Trace.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trace) == false) {
            return false;
        }
        Trace rhs = ((Trace) other);
