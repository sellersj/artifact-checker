...
public class ScanInfo__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__43> allOf = new ArrayList<AllOf__43>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__39 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__43> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__43> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__39 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__39 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ScanInfo__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScanInfo__1) == false) {
            return false;
        }
        ScanInfo__1 rhs = ((ScanInfo__1) other);
