...
public class Reference__1 {
    ...
    public String toString() {
        ...
        sb.append(Reference__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("source");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reference__1) == false) {
            return false;
        }
        Reference__1 rhs = ((Reference__1) other);
