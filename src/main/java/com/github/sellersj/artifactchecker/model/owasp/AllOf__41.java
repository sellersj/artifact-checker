...
public class AllOf__41 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__41.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__41) == false) {
            return false;
        }
        AllOf__41 rhs = ((AllOf__41) other);
