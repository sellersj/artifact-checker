...
public class ElementName__40 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__40.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__40) == false) {
            return false;
        }
        ElementName__40 rhs = ((ElementName__40) other);
