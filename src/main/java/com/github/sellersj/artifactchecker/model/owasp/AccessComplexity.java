...
public class AccessComplexity {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__93> allOf = new ArrayList<AllOf__93>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__80 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__93> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__93> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__80 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__80 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AccessComplexity.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccessComplexity) == false) {
            return false;
        }
        AccessComplexity rhs = ((AccessComplexity) other);
