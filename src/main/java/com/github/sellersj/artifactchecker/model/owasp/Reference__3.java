...
public class Reference__3 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__89> allOf = new ArrayList<AllOf__89>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__76 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__89> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__89> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__76 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__76 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Reference__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reference__3) == false) {
            return false;
        }
        Reference__3 rhs = ((Reference__3) other);
