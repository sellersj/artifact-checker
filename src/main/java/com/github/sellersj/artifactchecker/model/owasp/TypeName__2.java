...
public class TypeName__2 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__2) == false) {
            return false;
        }
        TypeName__2 rhs = ((TypeName__2) other);
