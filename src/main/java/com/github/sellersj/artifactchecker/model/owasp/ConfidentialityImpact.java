...
public class ConfidentialityImpact {
    ...
    @JsonProperty("allOf")
    private List<AllOf__20> allOf = new ArrayList<AllOf__20>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__19 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__20> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__20> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__19 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__19 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ConfidentialityImpact.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConfidentialityImpact) == false) {
            return false;
        }
        ConfidentialityImpact rhs = ((ConfidentialityImpact) other);
