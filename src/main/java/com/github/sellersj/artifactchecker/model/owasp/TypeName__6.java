...
public class TypeName__6 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__6.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__6) == false) {
            return false;
        }
        TypeName__6 rhs = ((TypeName__6) other);
