...
public class ElementName__47 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__47.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__47) == false) {
            return false;
        }
        ElementName__47 rhs = ((ElementName__47) other);
