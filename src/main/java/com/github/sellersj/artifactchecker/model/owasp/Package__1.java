...
public class Package__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__32> allOf = new ArrayList<AllOf__32>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__29 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__32> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__32> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__29 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__29 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Package__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Package__1) == false) {
            return false;
        }
        Package__1 rhs = ((Package__1) other);
