...
public class ElementName__48 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__48.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__48) == false) {
            return false;
        }
        ElementName__48 rhs = ((ElementName__48) other);
