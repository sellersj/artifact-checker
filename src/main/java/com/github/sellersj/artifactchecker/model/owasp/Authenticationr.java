...
public class Authenticationr {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__94> allOf = new ArrayList<AllOf__94>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__81 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__94> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__94> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__81 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__81 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Authenticationr.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Authenticationr) == false) {
            return false;
        }
        Authenticationr rhs = ((Authenticationr) other);
