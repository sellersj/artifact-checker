...
public class ElementName__17 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__17.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__17) == false) {
            return false;
        }
        ElementName__17 rhs = ((ElementName__17) other);
