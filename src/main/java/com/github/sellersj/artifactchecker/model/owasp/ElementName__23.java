...
public class ElementName__23 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__23.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__23) == false) {
            return false;
        }
        ElementName__23 rhs = ((ElementName__23) other);
