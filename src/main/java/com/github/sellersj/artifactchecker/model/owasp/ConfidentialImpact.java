...
public class ConfidentialImpact {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__95> allOf = new ArrayList<AllOf__95>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__82 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__95> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__95> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__82 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__82 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ConfidentialImpact.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConfidentialImpact) == false) {
            return false;
        }
        ConfidentialImpact rhs = ((ConfidentialImpact) other);
