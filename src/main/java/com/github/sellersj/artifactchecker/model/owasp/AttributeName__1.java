...
public class AttributeName__1 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__1) == false) {
            return false;
        }
        AttributeName__1 rhs = ((AttributeName__1) other);
