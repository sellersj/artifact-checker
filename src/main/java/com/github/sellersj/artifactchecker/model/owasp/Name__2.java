...
public class Name__2 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__24> allOf = new ArrayList<AllOf__24>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__23 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__24> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__24> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__23 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__23 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Name__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
