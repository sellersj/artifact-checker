...
public class AttributeName {
    ...
    public String toString() {
        ...
        sb.append(AttributeName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName) == false) {
            return false;
        }
        AttributeName rhs = ((AttributeName) other);
