...
public class Severity {
    ...
    @JsonProperty("allOf")
    private List<AllOf__1> allOf = new ArrayList<AllOf__1>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__1 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__1> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__1> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__1 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__1 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Severity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
