...
public class Name__3 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__28> allOf = new ArrayList<AllOf__28>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__27 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__28> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__28> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__27 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__27 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Name__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Name__3) == false) {
            return false;
        }
        Name__3 rhs = ((Name__3) other);
