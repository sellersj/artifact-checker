...
public class ElementName__72 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__72.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__72) == false) {
            return false;
        }
        ElementName__72 rhs = ((ElementName__72) other);
