...
public class ElementName__56 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__56.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__56) == false) {
            return false;
        }
        ElementName__56 rhs = ((ElementName__56) other);
