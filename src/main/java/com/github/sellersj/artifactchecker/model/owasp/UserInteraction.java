...
public class UserInteraction {
    ...
    @JsonProperty("allOf")
    private List<AllOf__18> allOf = new ArrayList<AllOf__18>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__17 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__18> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__18> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__17 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__17 elementName) {
    ...
    public String toString() {
        ...
        sb.append(UserInteraction.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UserInteraction) == false) {
            return false;
        }
        UserInteraction rhs = ((UserInteraction) other);
