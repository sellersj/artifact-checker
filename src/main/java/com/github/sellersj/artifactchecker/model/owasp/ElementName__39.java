...
public class ElementName__39 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__39.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__39) == false) {
            return false;
        }
        ElementName__39 rhs = ((ElementName__39) other);
