...
public class ElementName__88 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__88.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__88) == false) {
            return false;
        }
        ElementName__88 rhs = ((ElementName__88) other);
