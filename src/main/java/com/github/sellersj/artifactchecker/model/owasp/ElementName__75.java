...
public class ElementName__75 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__75.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__75) == false) {
            return false;
        }
        ElementName__75 rhs = ((ElementName__75) other);
