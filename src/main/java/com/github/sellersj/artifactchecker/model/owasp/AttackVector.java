...
public class AttackVector {
    ...
    @JsonProperty("allOf")
    private List<AllOf__15> allOf = new ArrayList<AllOf__15>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__14 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__15> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__15> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__14 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__14 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AttackVector.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttackVector) == false) {
            return false;
        }
        AttackVector rhs = ((AttackVector) other);
