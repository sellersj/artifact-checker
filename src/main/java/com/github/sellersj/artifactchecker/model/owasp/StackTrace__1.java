...
public class StackTrace__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__84> allOf = new ArrayList<AllOf__84>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__71 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__84> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__84> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__71 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__71 elementName) {
    ...
    public String toString() {
        ...
        sb.append(StackTrace__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StackTrace__1) == false) {
            return false;
        }
        StackTrace__1 rhs = ((StackTrace__1) other);
