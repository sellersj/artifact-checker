...
public class RelatedDependency__1 {
    ...
    @JsonProperty("typeName")
    public TypeName__6 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__6 typeName) {
    ...
    public String toString() {
        ...
        sb.append(RelatedDependency__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedDependency__1) == false) {
            return false;
        }
        RelatedDependency__1 rhs = ((RelatedDependency__1) other);
