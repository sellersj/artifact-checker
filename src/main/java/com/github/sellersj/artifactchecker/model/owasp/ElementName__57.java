...
public class ElementName__57 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__57.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__57) == false) {
            return false;
        }
        ElementName__57 rhs = ((ElementName__57) other);
