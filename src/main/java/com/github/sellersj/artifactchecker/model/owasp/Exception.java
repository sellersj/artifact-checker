...
public class Exception {
    ...
    @JsonProperty("typeName")
    public TypeName__5 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__5 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Exception.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
