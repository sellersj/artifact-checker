...
public class Cwes {
    ...
    private ElementName__4 elementName;
    ...
    @JsonProperty("elementName")
    public ElementName__4 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__4 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Cwes.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cwes) == false) {
            return false;
        }
        Cwes rhs = ((Cwes) other);
