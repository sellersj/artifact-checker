...
public class ElementName__14 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__14.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__14) == false) {
            return false;
        }
        ElementName__14 rhs = ((ElementName__14) other);
