...
public class ElementName__20 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__20.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__20) == false) {
            return false;
        }
        ElementName__20 rhs = ((ElementName__20) other);
