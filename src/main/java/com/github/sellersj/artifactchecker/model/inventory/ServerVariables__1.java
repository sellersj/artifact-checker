...
public class ServerVariables__1 {
    ...
    public String toString() {
        ...
        sb.append(ServerVariables__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ServerVariables__1) == false) {
            return false;
        }
        ServerVariables__1 rhs = ((ServerVariables__1) other);
