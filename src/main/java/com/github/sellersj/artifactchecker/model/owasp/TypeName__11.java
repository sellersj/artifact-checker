...
public class TypeName__11 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__11.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__11) == false) {
            return false;
        }
        TypeName__11 rhs = ((TypeName__11) other);
