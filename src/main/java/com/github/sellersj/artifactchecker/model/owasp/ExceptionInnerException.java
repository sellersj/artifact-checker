...
public class ExceptionInnerException {
    ...
    public String toString() {
        ...
        sb.append(ExceptionInnerException.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExceptionInnerException) == false) {
            return false;
        }
        ExceptionInnerException rhs = ((ExceptionInnerException) other);
