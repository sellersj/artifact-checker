...
public class ElementName__52 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__52.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__52) == false) {
            return false;
        }
        ElementName__52 rhs = ((ElementName__52) other);
