...
public class DependencyRelatedDependencies {
    ...
    public String toString() {
        ...
        sb.append(DependencyRelatedDependencies.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DependencyRelatedDependencies) == false) {
            return false;
        }
        DependencyRelatedDependencies rhs = ((DependencyRelatedDependencies) other);
