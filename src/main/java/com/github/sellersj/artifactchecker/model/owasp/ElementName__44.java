...
public class ElementName__44 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__44.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__44) == false) {
            return false;
        }
        ElementName__44 rhs = ((ElementName__44) other);
