...
public class VulnerableSoftware__1 {
    ...
    @JsonProperty("software")
    public void setSoftware(Software__1 software) {
    ...
    public String toString() {
        ...
        sb.append(VulnerableSoftware__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VulnerableSoftware__1) == false) {
            return false;
        }
        VulnerableSoftware__1 rhs = ((VulnerableSoftware__1) other);
