...
public class Properties__17 {
    ...
    private DataSource__1 dataSource;
    ...
    @JsonProperty("dataSource")
    public DataSource__1 getDataSource() {
        return dataSource;
    }

    @JsonProperty("dataSource")
    public void setDataSource(DataSource__1 dataSource) {
    ...
    public String toString() {
        ...
        sb.append(Properties__17.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Properties__17) == false) {
            return false;
        }
        Properties__17 rhs = ((Properties__17) other);
