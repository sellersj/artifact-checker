...
public class ElementName__10 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__10.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__10) == false) {
            return false;
        }
        ElementName__10 rhs = ((ElementName__10) other);
