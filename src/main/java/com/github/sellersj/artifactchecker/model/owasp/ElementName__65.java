...
public class ElementName__65 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__65.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__65) == false) {
            return false;
        }
        ElementName__65 rhs = ((ElementName__65) other);
