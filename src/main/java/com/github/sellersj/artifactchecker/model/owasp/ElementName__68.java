...
public class ElementName__68 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__68.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__68) == false) {
            return false;
        }
        ElementName__68 rhs = ((ElementName__68) other);
