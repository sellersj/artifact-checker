...
public class ElementName__5 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__5.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__5) == false) {
            return false;
        }
        ElementName__5 rhs = ((ElementName__5) other);
