...
public class ExceptionInnerExceptionStackTrace {
    ...
    public String toString() {
        ...
        sb.append(ExceptionInnerExceptionStackTrace.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExceptionInnerExceptionStackTrace) == false) {
            return false;
        }
        ExceptionInnerExceptionStackTrace rhs = ((ExceptionInnerExceptionStackTrace) other);
