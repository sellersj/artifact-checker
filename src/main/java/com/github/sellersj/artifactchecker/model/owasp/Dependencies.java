...
public class Dependencies {
    ...
    @JsonProperty("allOf")
    private List<AllOf__45> allOf = new ArrayList<AllOf__45>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__41 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__45> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__45> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__41 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__41 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Dependencies.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
