...
public class Reference__2 {
    ...
    @JsonProperty("typeName")
    public TypeName__1 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__1 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Reference__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reference__2) == false) {
            return false;
        }
        Reference__2 rhs = ((Reference__2) other);
