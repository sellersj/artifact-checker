...
public class ElementName__45 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__45.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__45) == false) {
            return false;
        }
        ElementName__45 rhs = ((ElementName__45) other);
