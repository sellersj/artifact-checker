...
public class ElementName__2 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__2) == false) {
            return false;
        }
        ElementName__2 rhs = ((ElementName__2) other);
