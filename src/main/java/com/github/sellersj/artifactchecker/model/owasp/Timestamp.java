...
public class Timestamp {
    ...
    @JsonProperty("allOf")
    private List<AllOf__25> allOf = new ArrayList<AllOf__25>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__24 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__25> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__25> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__24 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__24 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Timestamp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
