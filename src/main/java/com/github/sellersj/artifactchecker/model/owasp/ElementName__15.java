...
public class ElementName__15 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__15.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__15) == false) {
            return false;
        }
        ElementName__15 rhs = ((ElementName__15) other);
