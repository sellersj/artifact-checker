...
public class ElementName__78 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__78.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__78) == false) {
            return false;
        }
        ElementName__78 rhs = ((ElementName__78) other);
