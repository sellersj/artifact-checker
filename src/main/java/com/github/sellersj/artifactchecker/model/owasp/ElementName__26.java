...
public class ElementName__26 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__26.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__26) == false) {
            return false;
        }
        ElementName__26 rhs = ((ElementName__26) other);
