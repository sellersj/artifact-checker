...
public class TypeName__9 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__9.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__9) == false) {
            return false;
        }
        TypeName__9 rhs = ((TypeName__9) other);
