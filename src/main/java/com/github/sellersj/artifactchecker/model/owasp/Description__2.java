...
public class Description__2 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__72> allOf = new ArrayList<AllOf__72>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__60 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__72> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__72> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__60 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__60 elementName) {
