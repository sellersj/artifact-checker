...
public class TypeName__3 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__3) == false) {
            return false;
        }
        TypeName__3 rhs = ((TypeName__3) other);
