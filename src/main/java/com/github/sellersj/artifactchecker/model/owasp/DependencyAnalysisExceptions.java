...
public class DependencyAnalysisExceptions {
    ...
    public String toString() {
        ...
        sb.append(DependencyAnalysisExceptions.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DependencyAnalysisExceptions) == false) {
            return false;
        }
        DependencyAnalysisExceptions rhs = ((DependencyAnalysisExceptions) other);
