...
public class AnalysisDependencies {
    ...
    public String toString() {
        ...
        sb.append(AnalysisDependencies.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnalysisDependencies) == false) {
            return false;
        }
        AnalysisDependencies rhs = ((AnalysisDependencies) other);
