...
public class ElementName__69 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__69.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__69) == false) {
            return false;
        }
        ElementName__69 rhs = ((ElementName__69) other);
