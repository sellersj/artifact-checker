...
public class Id {
    ...
    @JsonProperty("allOf")
    private List<AllOf__35> allOf = new ArrayList<AllOf__35>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__32 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__35> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__35> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__32 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__32 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Id.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
