...
public class AttackComplexity {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__16> allOf = new ArrayList<AllOf__16>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__15 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__16> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__16> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__15 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__15 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AttackComplexity.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttackComplexity) == false) {
            return false;
        }
        AttackComplexity rhs = ((AttackComplexity) other);
