...
public class ElementName__77 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__77.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__77) == false) {
            return false;
        }
        ElementName__77 rhs = ((ElementName__77) other);
