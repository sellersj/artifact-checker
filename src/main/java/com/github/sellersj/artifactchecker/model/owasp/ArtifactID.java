...
public class ArtifactID {
    ...
    @JsonProperty("allOf")
    private List<AllOf__61> allOf = new ArrayList<AllOf__61>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__49 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__61> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__61> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__49 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__49 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ArtifactID.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArtifactID) == false) {
            return false;
        }
        ArtifactID rhs = ((ArtifactID) other);
