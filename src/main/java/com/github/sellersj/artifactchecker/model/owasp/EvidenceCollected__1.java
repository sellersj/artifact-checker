...
public class EvidenceCollected__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__77> allOf = new ArrayList<AllOf__77>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__65 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__77> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__77> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__65 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__65 elementName) {
    ...
    public String toString() {
        ...
        sb.append(EvidenceCollected__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EvidenceCollected__1) == false) {
            return false;
        }
        EvidenceCollected__1 rhs = ((EvidenceCollected__1) other);
