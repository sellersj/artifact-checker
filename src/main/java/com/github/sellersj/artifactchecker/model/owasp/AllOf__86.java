...
public class AllOf__86 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__14 items;
    ...
    @JsonProperty("items")
    public Items__14 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__14 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__86.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__86) == false) {
            return false;
        }
        AllOf__86 rhs = ((AllOf__86) other);
