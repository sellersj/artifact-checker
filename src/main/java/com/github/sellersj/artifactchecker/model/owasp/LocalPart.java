...
public class LocalPart {
    ...
    public String toString() {
        ...
        sb.append(LocalPart.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("_enum");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocalPart) == false) {
            return false;
        }
        LocalPart rhs = ((LocalPart) other);
