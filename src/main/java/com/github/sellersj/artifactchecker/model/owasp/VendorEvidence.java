...
public class VendorEvidence {
    ...
    public String toString() {
        ...
        sb.append(VendorEvidence.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VendorEvidence) == false) {
            return false;
        }
        VendorEvidence rhs = ((VendorEvidence) other);
