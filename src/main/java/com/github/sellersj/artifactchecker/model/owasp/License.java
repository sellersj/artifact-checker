...
public class License {
    ...
    @JsonProperty("allOf")
    private List<AllOf__73> allOf = new ArrayList<AllOf__73>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__61 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__73> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__73> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__61 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__61 elementName) {
    ...
    public String toString() {
        ...
        sb.append(License.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
