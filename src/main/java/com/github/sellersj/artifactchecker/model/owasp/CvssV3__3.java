...
public class CvssV3__3 {
    ...
    @JsonProperty("typeName")
    public TypeName__2 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__2 typeName) {
    ...
    public String toString() {
        ...
        sb.append(CvssV3__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CvssV3__3) == false) {
            return false;
        }
        CvssV3__3 rhs = ((CvssV3__3) other);
