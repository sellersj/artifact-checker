...
public class AllOf__40 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__40.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__40) == false) {
            return false;
        }
        AllOf__40 rhs = ((AllOf__40) other);
