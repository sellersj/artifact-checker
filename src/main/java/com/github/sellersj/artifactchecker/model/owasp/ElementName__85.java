...
public class ElementName__85 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__85.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__85) == false) {
            return false;
        }
        ElementName__85 rhs = ((ElementName__85) other);
