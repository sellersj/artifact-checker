...
public class ElementName__9 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__9.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__9) == false) {
            return false;
        }
        ElementName__9 rhs = ((ElementName__9) other);
