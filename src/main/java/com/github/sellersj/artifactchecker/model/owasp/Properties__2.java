...
public class Properties__2 {
    ...
    private Software__2 software;

    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("software")
    public Software__2 getSoftware() {
        return software;
    }

    @JsonProperty("software")
    public void setSoftware(Software__2 software) {
    ...
    public String toString() {
        ...
        sb.append(Properties__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("software");
        sb.append('=');
