...
public class ElementName__63 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__63.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__63) == false) {
            return false;
        }
        ElementName__63 rhs = ((ElementName__63) other);
