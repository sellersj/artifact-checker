...
public class AccessVector {
    ...
    @JsonProperty("allOf")
    private List<AllOf__92> allOf = new ArrayList<AllOf__92>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__79 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__92> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__92> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__79 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__79 elementName) {
    ...
    public String toString() {
        ...
        sb.append(AccessVector.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccessVector) == false) {
            return false;
        }
        AccessVector rhs = ((AccessVector) other);
