...
public class ElementName__62 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__62.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__62) == false) {
            return false;
        }
        ElementName__62 rhs = ((ElementName__62) other);
