...
public class Version {
    ...
    @JsonProperty("allOf")
    private List<AllOf__62> allOf = new ArrayList<AllOf__62>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__50 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__62> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__62> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__50 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__50 elementName) {
