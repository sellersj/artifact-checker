...
public class ElementName__54 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__54.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__54) == false) {
            return false;
        }
        ElementName__54 rhs = ((ElementName__54) other);
