...
public class AttributeName__7 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__7.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__7) == false) {
            return false;
        }
        AttributeName__7 rhs = ((AttributeName__7) other);
