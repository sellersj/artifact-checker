...
public class ElementName__32 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__32.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__32) == false) {
            return false;
        }
        ElementName__32 rhs = ((ElementName__32) other);
