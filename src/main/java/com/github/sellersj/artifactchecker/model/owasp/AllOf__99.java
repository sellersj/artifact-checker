...
public class AllOf__99 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__19 items;
    ...
    @JsonProperty("items")
    public Items__19 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__19 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__99.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__99) == false) {
            return false;
        }
        AllOf__99 rhs = ((AllOf__99) other);
