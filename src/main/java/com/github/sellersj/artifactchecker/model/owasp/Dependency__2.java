...
public class Dependency__2 {
    ...
    @JsonProperty("typeName")
    public TypeName__9 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__9 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Dependency__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dependency__2) == false) {
            return false;
        }
        Dependency__2 rhs = ((Dependency__2) other);
