...
public class Credits__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__64> allOf = new ArrayList<AllOf__64>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__52 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__64> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__64> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__52 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__52 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Credits__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Credits__1) == false) {
            return false;
        }
        Credits__1 rhs = ((Credits__1) other);
