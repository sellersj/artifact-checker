...
public class EngineVersion {
    ...
    @JsonProperty("allOf")
    private List<AllOf__81> allOf = new ArrayList<AllOf__81>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__68 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__81> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__81> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__68 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__68 elementName) {
    ...
    public String toString() {
        ...
        sb.append(EngineVersion.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EngineVersion) == false) {
            return false;
        }
        EngineVersion rhs = ((EngineVersion) other);
