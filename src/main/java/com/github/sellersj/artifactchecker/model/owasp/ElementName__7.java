...
public class ElementName__7 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__7.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__7) == false) {
            return false;
        }
        ElementName__7 rhs = ((ElementName__7) other);
