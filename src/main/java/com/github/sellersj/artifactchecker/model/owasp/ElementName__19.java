...
public class ElementName__19 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__19.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__19) == false) {
            return false;
        }
        ElementName__19 rhs = ((ElementName__19) other);
