...
public class ElementName__18 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__18.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__18) == false) {
            return false;
        }
        ElementName__18 rhs = ((ElementName__18) other);
