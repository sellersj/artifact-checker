...
public class ElementName {
    ...
    public String toString() {
        ...
        sb.append(ElementName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName) == false) {
            return false;
        }
        ElementName rhs = ((ElementName) other);
