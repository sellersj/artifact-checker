...
public class Vulnerabilities {
    ...
    @JsonProperty("allOf")
    private List<AllOf__79> allOf = new ArrayList<AllOf__79>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__67 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__79> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__79> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__67 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__67 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Vulnerabilities.class.getName()).append('@')
