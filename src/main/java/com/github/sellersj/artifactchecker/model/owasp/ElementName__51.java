...
public class ElementName__51 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__51.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__51) == false) {
            return false;
        }
        ElementName__51 rhs = ((ElementName__51) other);
