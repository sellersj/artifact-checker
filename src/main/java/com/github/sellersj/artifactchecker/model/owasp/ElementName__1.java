...
public class ElementName__1 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__1) == false) {
            return false;
        }
        ElementName__1 rhs = ((ElementName__1) other);
