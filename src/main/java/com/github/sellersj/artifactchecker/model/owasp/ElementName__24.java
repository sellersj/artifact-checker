...
public class ElementName__24 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__24.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__24) == false) {
            return false;
        }
        ElementName__24 rhs = ((ElementName__24) other);
