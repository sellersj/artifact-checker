...
public class ElementName__84 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__84.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__84) == false) {
            return false;
        }
        ElementName__84 rhs = ((ElementName__84) other);
