...
public class AllOf__65 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__65.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__65) == false) {
            return false;
        }
        AllOf__65 rhs = ((AllOf__65) other);
