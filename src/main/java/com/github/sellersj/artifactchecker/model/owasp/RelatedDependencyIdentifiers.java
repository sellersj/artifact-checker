...
public class RelatedDependencyIdentifiers {
    ...
    public String toString() {
        ...
        sb.append(RelatedDependencyIdentifiers.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedDependencyIdentifiers) == false) {
            return false;
        }
        RelatedDependencyIdentifiers rhs = ((RelatedDependencyIdentifiers) other);
