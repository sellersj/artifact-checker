...
public class ProjectInfo__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__44> allOf = new ArrayList<AllOf__44>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__40 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__44> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__44> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__40 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__40 elementName) {
    ...
    public String toString() {
        ...
        sb.append(ProjectInfo__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProjectInfo__1) == false) {
            return false;
        }
        ProjectInfo__1 rhs = ((ProjectInfo__1) other);
