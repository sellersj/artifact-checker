...
public class ElementName__73 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__73.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__73) == false) {
            return false;
        }
        ElementName__73 rhs = ((ElementName__73) other);
