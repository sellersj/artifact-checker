...
public class ElementName__11 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__11.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__11) == false) {
            return false;
        }
        ElementName__11 rhs = ((ElementName__11) other);
