...
public class ElementName__70 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__70.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__70) == false) {
            return false;
        }
        ElementName__70 rhs = ((ElementName__70) other);
