...
public class Identifiers__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__78> allOf = new ArrayList<AllOf__78>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__66 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__78> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__78> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__66 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__66 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Identifiers__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Identifiers__1) == false) {
            return false;
        }
        Identifiers__1 rhs = ((Identifiers__1) other);
