...
public class DependencyVulnerabilities {
    ...
    public String toString() {
        ...
        sb.append(DependencyVulnerabilities.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DependencyVulnerabilities) == false) {
            return false;
        }
        DependencyVulnerabilities rhs = ((DependencyVulnerabilities) other);
