...
public class Md5 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__49> allOf = new ArrayList<AllOf__49>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__45 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__49> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__49> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__45 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__45 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Md5.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
