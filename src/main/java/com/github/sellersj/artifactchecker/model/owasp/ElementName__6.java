...
public class ElementName__6 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__6.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__6) == false) {
            return false;
        }
        ElementName__6 rhs = ((ElementName__6) other);
