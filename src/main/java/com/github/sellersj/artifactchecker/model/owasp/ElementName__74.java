...
public class ElementName__74 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__74.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__74) == false) {
            return false;
        }
        ElementName__74 rhs = ((ElementName__74) other);
