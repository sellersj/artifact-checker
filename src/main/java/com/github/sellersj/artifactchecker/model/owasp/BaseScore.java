...
public class BaseScore {
    ...
    @JsonProperty("allOf")
    private List<AllOf__14> allOf = new ArrayList<AllOf__14>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__13 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__14> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__14> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__13 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__13 elementName) {
    ...
    public String toString() {
        ...
        sb.append(BaseScore.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BaseScore) == false) {
            return false;
        }
        BaseScore rhs = ((BaseScore) other);
