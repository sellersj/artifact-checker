...
public class ElementName__83 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__83.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__83) == false) {
            return false;
        }
        ElementName__83 rhs = ((ElementName__83) other);
