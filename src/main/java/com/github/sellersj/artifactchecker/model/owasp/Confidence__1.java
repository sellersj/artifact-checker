...
@JsonPropertyOrder({"title", "allOf", "propertyType", "attributeName"})
public class Confidence__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__39> allOf = new ArrayList<AllOf__39>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__3 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__39> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__39> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__3 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__3 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(Confidence__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Confidence__1) == false) {
            return false;
        }
        Confidence__1 rhs = ((Confidence__1) other);
        return ((((((this.allOf == rhs.allOf) || ((this.allOf != null) && this.allOf.equals(rhs.allOf)))
            && ((this.attributeName == rhs.attributeName)
                || ((this.attributeName != null) && this.attributeName.equals(rhs.attributeName))))
