...
public class ElementName__79 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__79.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__79) == false) {
            return false;
        }
        ElementName__79 rhs = ((ElementName__79) other);
