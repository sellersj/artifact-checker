...
public class IsVirtual {
    ...
    @JsonProperty("allOf")
    private List<AllOf__51> allOf = new ArrayList<AllOf__51>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__4 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__51> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__51> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__4 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__4 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(IsVirtual.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IsVirtual) == false) {
            return false;
        }
        IsVirtual rhs = ((IsVirtual) other);
