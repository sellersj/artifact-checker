...
public class ElementName__81 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__81.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__81) == false) {
            return false;
        }
        ElementName__81 rhs = ((ElementName__81) other);
