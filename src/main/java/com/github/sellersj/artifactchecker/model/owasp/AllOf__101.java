...
public class AllOf__101 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__21 items;
    ...
    @JsonProperty("items")
    public Items__21 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__21 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__101.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__101) == false) {
            return false;
        }
        AllOf__101 rhs = ((AllOf__101) other);
