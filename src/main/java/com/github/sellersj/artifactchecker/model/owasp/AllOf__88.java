...
public class AllOf__88 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__16 items;
    ...
    @JsonProperty("items")
    public Items__16 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__16 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__88.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__88) == false) {
            return false;
        }
        AllOf__88 rhs = ((AllOf__88) other);
