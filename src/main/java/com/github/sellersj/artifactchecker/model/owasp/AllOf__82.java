...
public class AllOf__82 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__10 items;
    ...
    @JsonProperty("items")
    public Items__10 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__10 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__82.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__82) == false) {
            return false;
        }
        AllOf__82 rhs = ((AllOf__82) other);
