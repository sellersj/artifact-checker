...
public class AllOf__42 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__42.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__42) == false) {
            return false;
        }
        AllOf__42 rhs = ((AllOf__42) other);
