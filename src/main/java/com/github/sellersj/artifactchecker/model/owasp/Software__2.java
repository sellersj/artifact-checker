...
public class Software__2 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__13> allOf = new ArrayList<AllOf__13>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__12 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__13> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__13> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__12 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__12 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Software__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Software__2) == false) {
            return false;
        }
        Software__2 rhs = ((Software__2) other);
