...
public class AllOf__90 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__18 items;
    ...
    @JsonProperty("items")
    public Items__18 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__18 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__90.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__90) == false) {
            return false;
        }
        AllOf__90 rhs = ((AllOf__90) other);
