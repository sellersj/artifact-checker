...
public class ElementName__31 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__31.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__31) == false) {
            return false;
        }
        ElementName__31 rhs = ((ElementName__31) other);
