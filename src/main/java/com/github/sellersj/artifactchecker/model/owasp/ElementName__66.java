...
public class ElementName__66 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__66.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__66) == false) {
            return false;
        }
        ElementName__66 rhs = ((ElementName__66) other);
