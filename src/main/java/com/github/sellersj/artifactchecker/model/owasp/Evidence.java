...
public class Evidence {
    ...
    @JsonProperty("typeName")
    public TypeName__3 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__3 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Evidence.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Evidence) == false) {
            return false;
        }
        Evidence rhs = ((Evidence) other);
