...
public class ElementName__41 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__41.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__41) == false) {
            return false;
        }
        ElementName__41 rhs = ((ElementName__41) other);
