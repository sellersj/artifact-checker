...
public class RelatedDependencies {
    ...
    @JsonProperty("allOf")
    private List<AllOf__75> allOf = new ArrayList<AllOf__75>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__63 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__75> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__75> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__63 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__63 elementName) {
    ...
    public String toString() {
        ...
        sb.append(RelatedDependencies.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedDependencies) == false) {
            return false;
        }
        RelatedDependencies rhs = ((RelatedDependencies) other);
