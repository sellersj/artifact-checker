...
public class Identifiers {
    ...
    @JsonProperty("allOf")
    private List<AllOf__50> allOf = new ArrayList<AllOf__50>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__46 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__50> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__50> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__46 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__46 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Identifiers.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
