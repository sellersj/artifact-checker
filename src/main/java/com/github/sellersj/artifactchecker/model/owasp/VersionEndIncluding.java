...
public class VersionEndIncluding {
    ...
    @JsonProperty("allOf")
    private List<AllOf__56> allOf = new ArrayList<AllOf__56>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__8 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__56> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__56> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__8 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__8 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(VersionEndIncluding.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VersionEndIncluding) == false) {
            return false;
        }
        VersionEndIncluding rhs = ((VersionEndIncluding) other);
