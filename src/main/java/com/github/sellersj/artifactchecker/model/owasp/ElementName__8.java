...
public class ElementName__8 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__8.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__8) == false) {
            return false;
        }
        ElementName__8 rhs = ((ElementName__8) other);
