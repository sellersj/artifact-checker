...
public class TypeName__5 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__5.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__5) == false) {
            return false;
        }
        TypeName__5 rhs = ((TypeName__5) other);
