...
public class ScanInfo__2 {
    ...
    @JsonProperty("typeName")
    public TypeName__10 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__10 typeName) {
    ...
    public String toString() {
        ...
        sb.append(ScanInfo__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScanInfo__2) == false) {
            return false;
        }
        ScanInfo__2 rhs = ((ScanInfo__2) other);
