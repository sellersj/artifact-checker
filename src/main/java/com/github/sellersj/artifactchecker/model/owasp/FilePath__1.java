...
public class FilePath__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__68> allOf = new ArrayList<AllOf__68>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__56 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__68> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__68> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__56 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__56 elementName) {
    ...
    public String toString() {
        ...
        sb.append(FilePath__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FilePath__1) == false) {
            return false;
        }
        FilePath__1 rhs = ((FilePath__1) other);
