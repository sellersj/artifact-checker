...
public class ElementName__29 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__29.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__29) == false) {
            return false;
        }
        ElementName__29 rhs = ((ElementName__29) other);
