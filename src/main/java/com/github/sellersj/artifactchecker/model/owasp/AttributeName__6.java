...
public class AttributeName__6 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__6.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__6) == false) {
            return false;
        }
        AttributeName__6 rhs = ((AttributeName__6) other);
