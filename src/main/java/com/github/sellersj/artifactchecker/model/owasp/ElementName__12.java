...
public class ElementName__12 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__12.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__12) == false) {
            return false;
        }
        ElementName__12 rhs = ((ElementName__12) other);
