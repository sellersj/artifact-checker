...
public class References {
    ...
    @JsonProperty("allOf")
    private List<AllOf__7> allOf = new ArrayList<AllOf__7>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__7 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__7> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__7> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__7 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__7 elementName) {
    ...
    public String toString() {
        ...
        sb.append(References.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
