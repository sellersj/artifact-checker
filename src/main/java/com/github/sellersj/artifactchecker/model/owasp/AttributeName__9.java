...
public class AttributeName__9 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__9.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__9) == false) {
            return false;
        }
        AttributeName__9 rhs = ((AttributeName__9) other);
