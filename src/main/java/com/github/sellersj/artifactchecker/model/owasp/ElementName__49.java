...
public class ElementName__49 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__49.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__49) == false) {
            return false;
        }
        ElementName__49 rhs = ((ElementName__49) other);
