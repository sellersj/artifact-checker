...
public class ElementName__50 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__50.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__50) == false) {
            return false;
        }
        ElementName__50 rhs = ((ElementName__50) other);
