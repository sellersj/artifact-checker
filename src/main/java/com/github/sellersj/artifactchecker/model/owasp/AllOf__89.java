...
public class AllOf__89 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__17 items;
    ...
    @JsonProperty("items")
    public Items__17 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__17 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__89.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__89) == false) {
            return false;
        }
        AllOf__89 rhs = ((AllOf__89) other);
