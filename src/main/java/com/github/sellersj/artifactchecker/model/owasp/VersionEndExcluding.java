...
public class VersionEndExcluding {
    ...
    @JsonProperty("allOf")
    private List<AllOf__57> allOf = new ArrayList<AllOf__57>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__9 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__57> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__57> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__9 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__9 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(VersionEndExcluding.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VersionEndExcluding) == false) {
            return false;
        }
        VersionEndExcluding rhs = ((VersionEndExcluding) other);
