...
public class ElementName__25 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__25.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__25) == false) {
            return false;
        }
        ElementName__25 rhs = ((ElementName__25) other);
