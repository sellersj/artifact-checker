...
public class ElementName__27 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__27.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__27) == false) {
            return false;
        }
        ElementName__27 rhs = ((ElementName__27) other);
