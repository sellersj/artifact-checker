...
public class ElementName__60 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__60.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__60) == false) {
            return false;
        }
        ElementName__60 rhs = ((ElementName__60) other);
