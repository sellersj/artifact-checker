...
public class ElementName__43 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__43.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__43) == false) {
            return false;
        }
        ElementName__43 rhs = ((ElementName__43) other);
