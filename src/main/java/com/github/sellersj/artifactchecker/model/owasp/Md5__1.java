...
public class Md5__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__69> allOf = new ArrayList<AllOf__69>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__57 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__69> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__69> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__57 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__57 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Md5__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Md5__1) == false) {
            return false;
        }
        Md5__1 rhs = ((Md5__1) other);
