...
@JsonPropertyOrder({"type", "title", "required", "properties", "typeType", "propertiesOrder"})
public class ScanInfoDataSource {
    ...
    public String toString() {
        ...
        sb.append(ScanInfoDataSource.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScanInfoDataSource) == false) {
            return false;
        }
        ScanInfoDataSource rhs = ((ScanInfoDataSource) other);
