...
public class TypeName {
    ...
    public String toString() {
        ...
        sb.append(TypeName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName) == false) {
            return false;
        }
        TypeName rhs = ((TypeName) other);
