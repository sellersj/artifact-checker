...
public class ElementName__55 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__55.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__55) == false) {
            return false;
        }
        ElementName__55 rhs = ((ElementName__55) other);
