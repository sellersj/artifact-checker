...
public class FileName {
    ...
    @JsonProperty("allOf")
    private List<AllOf__67> allOf = new ArrayList<AllOf__67>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__55 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__67> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__67> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__55 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__55 elementName) {
    ...
    public String toString() {
        ...
        sb.append(FileName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileName) == false) {
            return false;
        }
        FileName rhs = ((FileName) other);
