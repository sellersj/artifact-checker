...
public class AllOf__87 {

    @JsonProperty("type")
    private String type;

    @JsonProperty("items")
    private Items__15 items;
    ...
    @JsonProperty("items")
    public Items__15 getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(Items__15 items) {
        this.items = items;
    }
    ...
    public String toString() {
        ...
        sb.append(AllOf__87.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__87) == false) {
            return false;
        }
        AllOf__87 rhs = ((AllOf__87) other);
