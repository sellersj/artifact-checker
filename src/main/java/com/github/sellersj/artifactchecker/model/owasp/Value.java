...
public class Value {
    ...
    @JsonProperty("allOf")
    private List<AllOf__29> allOf = new ArrayList<AllOf__29>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__28 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__29> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__29> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__28 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__28 elementName) {
