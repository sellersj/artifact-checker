...
public class Url {
    ...
    @JsonProperty("allOf")
    private List<AllOf__11> allOf = new ArrayList<AllOf__11>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__10 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__11> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__11> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__10 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__10 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Url.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
