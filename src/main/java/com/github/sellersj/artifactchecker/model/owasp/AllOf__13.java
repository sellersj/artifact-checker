...
public class AllOf__13 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__13.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__13) == false) {
            return false;
        }
        AllOf__13 rhs = ((AllOf__13) other);
