...
public class ElementName__16 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__16.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__16) == false) {
            return false;
        }
        ElementName__16 rhs = ((ElementName__16) other);
