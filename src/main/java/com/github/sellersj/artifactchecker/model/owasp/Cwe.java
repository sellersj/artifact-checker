...
public class Cwe {
    ...
    @JsonProperty("allOf")
    private List<AllOf__101> allOf = new ArrayList<AllOf__101>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__88 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__101> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__101> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__88 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__88 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Cwe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
