...
@JsonPropertyOrder({"type", "title", "properties", "typeType", "typeName", "propertiesOrder"})
public class Software__3 {
    ...
    @JsonProperty("typeName")
    public TypeName__7 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__7 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Software__3.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Software__3) == false) {
            return false;
        }
        Software__3 rhs = ((Software__3) other);
