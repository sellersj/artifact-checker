...
public class Sha1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__48> allOf = new ArrayList<AllOf__48>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__44 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__48> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__48> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__44 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__44 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Sha1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sha1) == false) {
            return false;
        }
        Sha1 rhs = ((Sha1) other);
