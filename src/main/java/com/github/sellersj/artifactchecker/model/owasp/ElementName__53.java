...
public class ElementName__53 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__53.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__53) == false) {
            return false;
        }
        ElementName__53 rhs = ((ElementName__53) other);
