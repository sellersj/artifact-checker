...
public class ElementName__82 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__82.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__82) == false) {
            return false;
        }
        ElementName__82 rhs = ((ElementName__82) other);
