...
public class AttributeName__4 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__4.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__4) == false) {
            return false;
        }
        AttributeName__4 rhs = ((AttributeName__4) other);
