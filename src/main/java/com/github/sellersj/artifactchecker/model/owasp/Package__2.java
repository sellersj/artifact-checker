...
public class Package__2 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__85> allOf = new ArrayList<AllOf__85>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__72 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__85> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__85> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__72 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__72 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Package__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Package__2) == false) {
            return false;
        }
        Package__2 rhs = ((Package__2) other);
