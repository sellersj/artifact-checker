...
public class ElementName__59 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__59.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__59) == false) {
            return false;
        }
        ElementName__59 rhs = ((ElementName__59) other);
