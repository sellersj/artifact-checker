...
public class ElementName__80 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__80.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__80) == false) {
            return false;
        }
        ElementName__80 rhs = ((ElementName__80) other);
