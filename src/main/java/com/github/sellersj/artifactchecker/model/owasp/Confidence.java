...
public class Confidence {
    ...
    @JsonProperty("allOf")
    private List<AllOf__31> allOf = new ArrayList<AllOf__31>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__2 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__31> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__31> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__2 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__2 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(Confidence.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
