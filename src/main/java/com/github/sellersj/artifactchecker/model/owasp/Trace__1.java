...
public class Trace__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__66> allOf = new ArrayList<AllOf__66>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__54 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__66> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__66> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__54 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__54 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Trace__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trace__1) == false) {
            return false;
        }
        Trace__1 rhs = ((Trace__1) other);
