...
public class ElementName__30 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__30.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__30) == false) {
            return false;
        }
        ElementName__30 rhs = ((ElementName__30) other);
