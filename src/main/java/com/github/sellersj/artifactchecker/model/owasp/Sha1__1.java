...
public class Sha1__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__70> allOf = new ArrayList<AllOf__70>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__58 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__70> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__70> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__58 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__58 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Sha1__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sha1__1) == false) {
            return false;
        }
        Sha1__1 rhs = ((Sha1__1) other);
