...
public class AttributeName__2 {
    ...
    public String toString() {
        ...
        sb.append(AttributeName__2.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeName__2) == false) {
            return false;
        }
        AttributeName__2 rhs = ((AttributeName__2) other);
