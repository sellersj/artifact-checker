...
public class CvssV2__2 {
    ...
    private ElementName__2 elementName;
    ...
    @JsonProperty("elementName")
    public ElementName__2 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__2 elementName) {
    ...
    public String toString() {
        ...
        sb.append(CvssV2__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CvssV2__2) == false) {
            return false;
        }
        CvssV2__2 rhs = ((CvssV2__2) other);
