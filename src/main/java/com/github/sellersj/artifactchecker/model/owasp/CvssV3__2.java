...
public class CvssV3__2 {
    ...
    private ElementName__3 elementName;
    ...
    @JsonProperty("elementName")
    public ElementName__3 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__3 elementName) {
    ...
    public String toString() {
        ...
        sb.append(CvssV3__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CvssV3__2) == false) {
            return false;
        }
        CvssV3__2 rhs = ((CvssV3__2) other);
