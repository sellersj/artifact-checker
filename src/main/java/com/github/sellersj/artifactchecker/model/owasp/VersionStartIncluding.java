...
public class VersionStartIncluding {
    ...
    @JsonProperty("allOf")
    private List<AllOf__54> allOf = new ArrayList<AllOf__54>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__6 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__54> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__54> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__6 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__6 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(VersionStartIncluding.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VersionStartIncluding) == false) {
            return false;
        }
        VersionStartIncluding rhs = ((VersionStartIncluding) other);
