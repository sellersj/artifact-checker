...
public class TypeName__10 {
    ...
    public String toString() {
        ...
        sb.append(TypeName__10.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("localPart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TypeName__10) == false) {
            return false;
        }
        TypeName__10 rhs = ((TypeName__10) other);
