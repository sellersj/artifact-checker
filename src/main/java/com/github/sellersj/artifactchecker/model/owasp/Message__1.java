...
public class Message__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__83> allOf = new ArrayList<AllOf__83>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__70 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__83> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__83> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__70 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__70 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Message__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
