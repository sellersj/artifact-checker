...
public class Identifier {
    ...
    @JsonProperty("typeName")
    public TypeName__4 getTypeName() {
        return typeName;
    }

    @JsonProperty("typeName")
    public void setTypeName(TypeName__4 typeName) {
    ...
    public String toString() {
        ...
        sb.append(Identifier.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
