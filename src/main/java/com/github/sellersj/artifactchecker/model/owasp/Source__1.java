...
public class Source__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__10> allOf = new ArrayList<AllOf__10>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__9 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__10> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__10> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__9 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__9 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Source__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Source__1) == false) {
            return false;
        }
        Source__1 rhs = ((Source__1) other);
