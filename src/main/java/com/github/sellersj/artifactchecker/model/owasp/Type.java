...
public class Type {
    ...
    @JsonProperty("allOf")
    private List<AllOf__30> allOf = new ArrayList<AllOf__30>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("attributeName")
    private AttributeName__1 attributeName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__30> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__30> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("attributeName")
    public AttributeName__1 getAttributeName() {
        return attributeName;
    }

    @JsonProperty("attributeName")
    public void setAttributeName(AttributeName__1 attributeName) {
    ...
    public String toString() {
        ...
        sb.append(Type.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
