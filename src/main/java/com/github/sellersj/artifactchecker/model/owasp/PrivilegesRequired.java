...
public class PrivilegesRequired {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__17> allOf = new ArrayList<AllOf__17>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__16 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__17> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__17> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__16 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__16 elementName) {
    ...
    public String toString() {
        ...
        sb.append(PrivilegesRequired.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PrivilegesRequired) == false) {
            return false;
        }
        PrivilegesRequired rhs = ((PrivilegesRequired) other);
