...
public class Description {
    ...
    @JsonProperty("allOf")
    private List<AllOf__5> allOf = new ArrayList<AllOf__5>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__5 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__5> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__5> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__5 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__5 elementName) {
