...
public class AllOf__66 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__66.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__66) == false) {
            return false;
        }
        AllOf__66 rhs = ((AllOf__66) other);
