...
public class Url__1 {
    ...
    @JsonProperty("allOf")
    private List<AllOf__36> allOf = new ArrayList<AllOf__36>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__33 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__36> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__36> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__33 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__33 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Url__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
