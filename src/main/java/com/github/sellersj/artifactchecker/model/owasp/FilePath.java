...
public class FilePath {
    ...
    @JsonProperty("allOf")
    private List<AllOf__46> allOf = new ArrayList<AllOf__46>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__42 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__46> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__46> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__42 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__42 elementName) {
    ...
    public String toString() {
        ...
        sb.append(FilePath.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FilePath) == false) {
            return false;
        }
        FilePath rhs = ((FilePath) other);
