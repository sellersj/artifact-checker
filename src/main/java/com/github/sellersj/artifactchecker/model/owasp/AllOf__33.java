...
public class AllOf__33 {
    ...
    public String toString() {
        ...
        sb.append(AllOf__33.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllOf__33) == false) {
            return false;
        }
        AllOf__33 rhs = ((AllOf__33) other);
