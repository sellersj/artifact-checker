...
public class ElementName__22 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__22.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__22) == false) {
            return false;
        }
        ElementName__22 rhs = ((ElementName__22) other);
