...
public class Notes {
    ...
    private ElementName__6 elementName;
    ...
    @JsonProperty("elementName")
    public ElementName__6 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__6 elementName) {
    ...
    public String toString() {
        ...
        sb.append(Notes.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[');
        sb.append("title");
        sb.append('=');
