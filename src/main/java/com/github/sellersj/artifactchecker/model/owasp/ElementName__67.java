...
public class ElementName__67 {
    ...
    public String toString() {
        ...
        sb.append(ElementName__67.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElementName__67) == false) {
            return false;
        }
        ElementName__67 rhs = ((ElementName__67) other);
