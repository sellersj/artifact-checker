...
public class VulnerableSoftware__2 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__8> allOf = new ArrayList<AllOf__8>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__8 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__8> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__8> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__8 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__8 elementName) {
    ...
    public String toString() {
        ...
        sb.append(VulnerableSoftware__2.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VulnerableSoftware__2) == false) {
            return false;
        }
        VulnerableSoftware__2 rhs = ((VulnerableSoftware__2) other);
