...
public class IntegrityImpact__1 {

    @JsonProperty("title")
    private String title;

    @JsonProperty("allOf")
    private List<AllOf__96> allOf = new ArrayList<AllOf__96>();

    @JsonProperty("propertyType")
    private String propertyType;

    @JsonProperty("elementName")
    private ElementName__83 elementName;
    ...
    @JsonProperty("allOf")
    public List<AllOf__96> getAllOf() {
        return allOf;
    }

    @JsonProperty("allOf")
    public void setAllOf(List<AllOf__96> allOf) {
        this.allOf = allOf;
    }
    ...
    @JsonProperty("elementName")
    public ElementName__83 getElementName() {
        return elementName;
    }

    @JsonProperty("elementName")
    public void setElementName(ElementName__83 elementName) {
    ...
    public String toString() {
        ...
        sb.append(IntegrityImpact__1.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IntegrityImpact__1) == false) {
            return false;
        }
        IntegrityImpact__1 rhs = ((IntegrityImpact__1) other);
